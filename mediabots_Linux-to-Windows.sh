...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://gemmei.ftp.acc.umu.se/mirror/osdn.net/android-x86/67834/android-x86-7.1-r5-k419.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://gemmei.ftp.acc.umu.se/mirror/osdn.net/android-x86/67834/android-x86-7.1-r5-k419.iso
else
